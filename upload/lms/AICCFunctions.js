...
function AICC_SetObjectiveScore(strObjectiveID, intScore, intMaxScore, intMinScore){
	...
	if (intObjIndex != null){
		...
		AICC_aryObjectivesRead[parseInt(intNextID)] = new Array(3);
		AICC_aryObjectivesRead[parseInt(intNextID)][AICC_OBJ_ARRAY_ID] = strObjectiveID;			
		AICC_aryObjectivesRead[parseInt(intNextID)][AICC_OBJ_ARRAY_SCORE] = intScore;
		AICC_aryObjectivesRead[parseInt(intNextID)][AICC_OBJ_ARRAY_STATUS] = "";
	}
	...
	if (intObjIndex != null){
		...
		AICC_aryObjectivesWrite[parseInt(intNextID)] = new Array(3);
		...
		AICC_aryObjectivesWrite[parseInt(intNextID)][AICC_OBJ_ARRAY_ID] = strObjectiveID;			
		AICC_aryObjectivesWrite[parseInt(intNextID)][AICC_OBJ_ARRAY_SCORE] = strAICCScore;
		AICC_aryObjectivesWrite[parseInt(intNextID)][AICC_OBJ_ARRAY_STATUS] = "";
	}
...
function AICC_SetObjectiveStatus(strObjectiveID, Lesson_Status){
	...
	if (intObjIdex != null){
		...
		AICC_aryObjectivesRead[parseInt(intNextID)][AICC_OBJ_ARRAY_ID] = strObjectiveID;			
		AICC_aryObjectivesRead[parseInt(intNextID)][AICC_OBJ_ARRAY_STATUS] = Lesson_Status;
		AICC_aryObjectivesRead[parseInt(intNextID)][AICC_OBJ_ARRAY_SCORE] = "";
	}
	...
	if (intObjIdex != null){
		...
		AICC_aryObjectivesWrite[parseInt(intNextID)][AICC_OBJ_ARRAY_ID] = strObjectiveID;			
		AICC_aryObjectivesWrite[parseInt(intNextID)][AICC_OBJ_ARRAY_STATUS] = Lesson_Status;
		AICC_aryObjectivesWrite[parseInt(intNextID)][AICC_OBJ_ARRAY_SCORE] = "";
	}
...
function AICC_TranslateAudio(strAudio){
	...
	var intTempPreference = parseInt(strAudio);
...
function AICC_TranslateSpeed(intAICCSpeed){
	...
	intAICCSpeed = parseInt(intAICCSpeed)
...
function AICC_FormatObjectives(strObjectivesFromLMS){
	...
	for (i=0; i < aryLines.length; i++){
		...
		AICC_aryObjectivesRead[parseInt(strIndex)] = new Array(3);
	}
	...
	for (i=0; i < aryLines.length; i++){
		...
		if (strLineType == "j_id"){
			...
			AICC_aryObjectivesRead[parseInt(strIndex)][AICC_OBJ_ARRAY_ID] = strLineValue;
		}
		else if (strLineType =="j_st"){
			WriteToDebug("Found Status");
			AICC_aryObjectivesRead[parseInt(strIndex)][AICC_OBJ_ARRAY_STATUS] = AICC_ConvertAICCStatusIntoLocalStatus(strLineValue.charAt(0).toLowerCase());
		}
		else if (strLineType == "j_sc"){
			WriteToDebug("Found Score");
			AICC_aryObjectivesRead[parseInt(strIndex)][AICC_OBJ_ARRAY_SCORE] = AICC_ExtractSingleScoreFromObjective(strLineValue);
		}
		else{
